export const data = {
    ...
    skills: [
        ...
        {
            name: 'CSS3',
            logo: 'https://static-00.iconduck.com/assets.00/file-type-css-icon-902x1024-dqy5inwy.png',
        },
        {
            name: 'JavaScript',
        ...
        {
            name: 'MySQL',
            logo: 'https://pngimg.com/d/mysql_PNG9.png',
        },
        {
            name: 'Java',
        ...
        {
            name: 'Spring Boot',
            logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Spring_Boot.svg/640px-Spring_Boot.svg.png',
        },
        {
            name: 'Git',
